...
((1461*(ano+4800+(mes-14)/12))/4+(367*(mes-2-12*((mes-14)/12)))/12- (3*((ano+4900+(mes14)/12)/100))/4+ dia-32075) 
O valor retornado(0 a 6) corresponde aos seguintes dias da semana: 0 –
